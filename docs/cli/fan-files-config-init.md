# fan-files config init

Initialize a new database

## Synopsis

Initialize a new database to use with fan-files. All of
...
```
  ...
  -b, --baseURL string                   base url
      ...
      --branding.name string             replace 'fan-files' by this name
